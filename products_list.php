 <?php
	$Page="all"; 
	include "header.php"; 
	$product_sub_category_name=$_GET["pc_name"];
 ...
 $sql="SELECT  b.category_display_name,b.product_category_name,c.sub_category_display_name,c.product_sub_category_name FROM  product_category b  
	...
	where c.product_sub_category_name='".$product_sub_category_name."'";
...
<section id="main-container" class="main-container">
  <div class="container">
    <div class="row">
        <div class="col-lg-12">
           <h3 class="column-title"><?php echo $sub_category_display_name ; ?></h3> 
		  <?php
